...
WeixinRailsMiddleware.configure do |config|
  ...
  # config.weixin_token_string = '50370c09e80d8a9e30c70396'
  # using to weixin server url to validate the token can be trusted.
  # config.weixin_secret_string = '5dRqlSzXoN-w5jKFLie8jBUkIRUbFvZk'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = '74549a9fdbd008ac289b35a6c1fb71e6b28644e05c3'
